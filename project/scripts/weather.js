...
const myLat = "35.682839";
const myLong = "139.759455";
...
function displayCurrentWeather(data) {
    ...
    if (currentDiv) {
        currentDiv.innerHTML = `
            ...
            <p>Current weather in Tokyo is ${currentWeather.condition.text}</p>
...
// Fetch weather for Tokyo, Japan using latitude and longitude
